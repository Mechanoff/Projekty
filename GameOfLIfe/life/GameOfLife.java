...
public class GameOfLife extends JFrame implements Runnable{ // UI class of the application
    ...
    /*public void initWindow(){// initialize the window. The main window consists the game panel
        ...
        jFrame.setSize(1000, 1000);// set size of frame to 800,800
    ...
    public void reset(ChangeListener sliderController,ItemListener itemListener) {
        getContentPane().remove(gameField);// remove components
        controllerPanel.remove(slider);
        initGameLogic();
        createSlider();
        slider.addChangeListener(sliderController);
        ...
        controllerPanel.repaint();
        validate();// revalidate components. Make them valid and they will reappear
